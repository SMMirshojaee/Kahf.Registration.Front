  ...
  ngOnInit() {
    if (false)
      this.confirmationService.confirm({
        message: 'زائر گرامی،\n' +
          '\n' +
          'به‌منظور دریافت اطلاع‌رسانی‌ها و پیامک‌های مربوط به فرایند ثبت‌نام ، لطفاً از فعال بودن امکان دریافت پیامک‌های تبلیغاتی روی سیم‌کارت خود اطمینان حاصل فرمایید.\n' +
          '\n' +
          'خاطرنشان می‌گردد پیامک‌های این سامانه از طریق سرشماره 30007487123465 ارسال می‌شوند',
        header: 'توجه',
